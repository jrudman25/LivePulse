  ...
  return (
    <div className="mx-auto grid min-h-[calc(100vh-72px)] w-full max-w-[1600px] border-x border-[#45413c] lg:grid-cols-[minmax(0,1fr)_560px]">
      <div className="broadcast-grid hidden flex-col justify-between border-r border-[#45413c] p-12 lg:flex">
        <span className="font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#aaa49b]">Access control / 01</span>
        <div>
          <p className="mb-4 flex items-center gap-3 font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#ed2f24]"><span className="h-2.5 w-2.5 bg-[#ed2f24]" />Secure room entry</p>
          <h1 className="font-heading text-8xl font-black uppercase leading-[0.82] tracking-[-0.045em] text-[#f2efe8]">Return to<br />your event<br />rooms.</h1>
        </div>
        <p className="max-w-md text-sm leading-relaxed text-[#aaa49b]">Sign in to save events and take part in their conversations.</p>
      </div>
